...
//                    Opening the main form if login is successful
...
//                CHECK IF USERNAME ALREADY EXISTS
                ...
                if (result.next()) {
                    ...
                    alert.setTitle("Error Message");
                    alert.setHeaderText(null);
                    alert.setContentText("Password mus have more than 6 characters");
                    alert.showAndWait();
    ...
    private String[] questionList = {"What is your favourate color?", "What is your favourite food?", "What is your birth date?"};
            ...
            if (np_newPassword.getText().equals(np_confirmPassword.getText())) {
                ...
                try {
                    ...
                    String updatePass = "UPDATE employee SET password = '" 
                            + np_newPassword.getText() + "' WHERE username = '" 
                            + fp_username.getText() + "' ";
